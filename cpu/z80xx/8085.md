...
| 28 | LDHI | d8 | data | imm | 2 | 3 | 10 | ```........``` | LDHI d8 |DE <- HL + byte_2 |
...
| 38 | LDSI | d8 | data | imm | 2 | 3 | 10 | ```........``` | LDSI d8 |DE <- SP + byte_2 |
...
| **D** | RNC  | POP D | JNC a16 | OUT d8 | CNC a16 | PUSH D | SUI d8 | RST 2 | RC  | SHLX  | JC a16 | IN d8 | CC a16 | JNK a16 | SBI d8 | RST 3 |
